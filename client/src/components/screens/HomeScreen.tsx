...
const HomeScreen: React.FC = () => (
    <ScreenArea>
        ...
        <Text>
            Gun six pounders fire in the hole barque no prey, no pay clipper transom port barkadeer yard. Rigging dead
            men tell no tales long boat run a shot across the bow sutler hearties boatswain gaff snow tackle. Barkadeer
            ...
            pounders bilge rat lanyard tender aft mizzen draught heave to reef sails. Provost rigging mutiny bowsprit
        ...
        <Text>
            ...
            volutpizzle, suscipit quis, fo shizzle my nizzle vizzle, arcu. Pellentesque hizzle tortor. Dizzle erizzle.
            Things at dolor dapibizzle turpis tempus bling bling. Maurizzle pellentesque nibh izzle away. Izzle izzle
            get down get down. Phat fizzle rhoncus that's the shizzle. In boofron habitasse nizzle . Bow wow wow
            dapibizzle. Curabitur tellizzle own yo', pretizzle shizzle my nizzle crocodizzle, shizznit break it down,
