...
const ConfigureScreen: React.FC = () => (
  <ScreenArea>
    ...
    <SubHeaderText>Portal settings</SubHeaderText>
    <Words>Here you can set local client settings such as theme</Words>

    <SubHeaderText>Server settings</SubHeaderText>

    <Words>Configure dynamic update period, security, and restrictions</Words>
  </ScreenArea>
);
